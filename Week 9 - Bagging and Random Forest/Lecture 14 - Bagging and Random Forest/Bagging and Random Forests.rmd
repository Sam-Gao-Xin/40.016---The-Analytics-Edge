...
setwd("/Users/james/OneDrive - Singapore University of Technology and Design/SUTD/Year 3/Term 6/40.016 - The Analytics Edge/Week 9 - Bagging and Random Forest/Lecture 14 - Bagging and Random Forest")  # Setup the working directory
```
...
```{r}
#this counts the number of time a predictor variable is used in the random forest
