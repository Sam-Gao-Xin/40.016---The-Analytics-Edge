...
```{r}
#Calculation of the average of the probabilities of the actual shares of the house
table(heating$depvar)/nrow(heating)

#Calculation of the average of the probabilities of the predicted share of the house
